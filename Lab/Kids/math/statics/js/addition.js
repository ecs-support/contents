  ...
  var modal_content = document.getElementById("model_content");
  ...
  input.addEventListener("keyup", function (event) {
    ...
    function CheckResult() {
      ...
      var operations = document.getElementById("symbol").innerHTML;
      var results = "";
      var answers = 0;
      var descs = "";
      
    answers = Number(num_first) + Number(num_second);
    descs = num_first + " + " + num_second + " = " + num_result;
      ...
      if (num_result == answers) {
        results =
          "<img src= './statics/img/true.png' alt='True' style='width:24px;height:24px;'>";
        /*       "<i class='far fa-check-circle' style='font-size:20px;color:green'></i>";  */
        result_true++;
      } else {
        results =
          "<img src= './statics/img/false.png' alt='False' style='width:24px;height:24px;'>";
      ...
      if (counts > 9) {
        /*  modal_content.innerHTML = "ตอบถูก " + result_true + 'ข้อ' + 'ใช้เวลารวม: '+ mins + ' : ' + secs; */
       document.getElementById("myModal").style.display = "block";
       document.getElementById("finish_01").innerHTML =
         "ทำถูกทั้งหมด " + result_true + " จาก " + counts+ " ข้อ";
       document.getElementById("finish_02").innerHTML =
         "ใช้เวลารวม " + h1.textContent;
      }
    }
