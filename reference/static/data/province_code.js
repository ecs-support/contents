var dataSet = [
  ...
  ['14', 'พระนครศรีอยุธยา', 'PHRANAKHON SI AYUTTAYA'],
  ['15', 'อ่างทอง', 'ANG THONG'],
  ['16', 'ลพบุรี', 'LOP BURI'],
  ['17', 'สิงห์บุรี', 'SING BURI'],
  ['18', 'ชัยนาท', 'CHAI NAT'],
  ['19', 'สระบุรี', 'SARA BURI'],
  ['20', 'ชลบุรี', 'CHON BURI'],
  ['21', 'ระยอง', 'RAYONG'],
  ['22', 'จันทบุรี', 'CHANTHABURI'],
  ['23', 'ตราด', 'TRAT'],
  ['24', 'ฉะเชิงเทรา', 'CHA CHOENG SAO'],
  ...
  ['37', 'อำนาจเจริญ', 'UMNAD CHAREUN'],
  ['38', 'บึงกาฬ', 'BUNGKAN'],
  ['39', 'หนองบัวลำภู', 'NONGBUA LUMPHOO'],
  ...
  ['77', 'ประจวบคีรีขันธ์', 'PHACHUAP KHIRI KHAN'],
...
$(document).ready(function () {
  $("#table-ref").DataTable({
    ...
    columns: [
      ...
      { title: "ชื่อจังหวัด (TH)" },
      { title: "ชื่อจังหวัด (EN)" },
    ],
    responsive: true,
  });
