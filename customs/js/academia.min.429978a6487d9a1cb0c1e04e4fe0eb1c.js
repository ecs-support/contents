 ...
 */ !(function (e, t) {
      ...
      return (
        ...
        (e._slide = function (e, n) {
          var a,
            ...
            u = e === oe ? ((a = En), (r = Cn), Dn) : ((a = kn), (r = yn), Tn);
          o && t(o).hasClass(v)
            ? (this._isSliding = !1)
  ...
  (function (e) {
    ...
    function j() {
      let t = e("body"),
        s = t.data("bs.scrollspy");
      s &&
        ((s._config.offset = n),
        t.data("bs.scrollspy", s),
        t.scrollspy("refresh"));
    }
    function p() {
    ...
    e("nav a, .page-scroll").on("click", function () {
      if (
        ...
        if (t.length)
          return (
            u.animate({ scrollTop: t.offset().top - n }, 1500, "easeInOutExpo"),
            !1
          );
      }
    }),
      (c = document.getElementsByClassName("collapsible"));
    ...
    let m = e(".filter-search").keyup(
      f(function () {
        (l = new RegExp(m.val(), "gi")), s.isotope();
      })
    );
    function f(e, t) {
      let n;
    ...
    e(".pub-filters").on("change", function () {
      let o = e(this),
        n = o[0].getAttribute("data-filter-group");
      if (((i[n] = this.value), (t = d(i)), s.isotope(), n == "pubtype")) {
        let t = e(this).val();
    ...
    function g() {
      let n = window.location.hash.replace("#", ""),
        o = "*";
      n != "" && !isNaN(n) && (o = ".pubtype-" + n);
      let a = "pubtype";
      (i[a] = o), (t = d(i)), s.isotope(), e(".pubtype-select").val(o);
    }
    function v() {
      if (e("#map").length) {
    ...
    e(document).ready(function () {
      ...
      let a = parseInt(localStorage.getItem("dark_mode") || i);
      ...
      e(window).on("load", function () {
        window.location.hash &&
          (window.location.hash == "#top"
            ? (window.location.hash = "")
            : e(".projects-container").length || a());
        let o = e("body");
        o.scrollspy({ offset: n });
        let s;
        e(window).resize(function () {
          clearTimeout(s), (s = setTimeout(j, 200));
        }),
          ...
          v();
        let t = ".js-github-release";
        e(t).length > 0 && b(t, e(t).data("repo")),
          e(".js-search").click(function (e) {
            e.preventDefault(), r();
          }),
          e(document).on("keydown", function (t) {
            t.which == 27
              ? e("body").hasClass("searching") && r()
              : t.which == 191 &&
                t.shiftKey == !1 &&
      ...
      e(window).on("load resize orientationchange", _);
  })(jQuery);
let fuseOptions = {
    shouldSort: !0,
    includeMatches: !0,
